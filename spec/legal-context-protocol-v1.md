...
| `atrHash` | string | OPTIONAL | SHA-256 hash of the **Agentic Transaction Receipt** (ATR) — the ATR is the terms document itself (the standalone artifact of Section 2.3), and `atrHash` is its digest. `0x`-prefixed hex (66 characters). See [Level 2](#level-2-provable). |
